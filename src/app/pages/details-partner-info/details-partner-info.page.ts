...
@Component({
  selector: 'app-details-partner-info',
  templateUrl: './details-partner-info.page.html',
  styleUrls: ['./details-partner-info.page.scss'],
})
export class DetailsPartnerInfoPage implements OnInit {
  postData = {
    id: '',
    location: ''
  }
  ...
  constructor(private route: ActivatedRoute, private router: Router, private authService: AuthService, private toastService: ToastService, private alertController: AlertController, private platform: Platform) {
    ...
    this.route.queryParams.subscribe(params => {
      if (this.router.getCurrentNavigation().extras.state) {
        ...
        this.authService.getSubPartner(this.postData).subscribe(
          (res: any) => {
